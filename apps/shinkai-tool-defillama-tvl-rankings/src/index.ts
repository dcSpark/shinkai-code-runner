...
export class Tool extends BaseTool<Config, Params, Result> {
  definition: ToolDefinition<Config, Params, Result> = {
    ...
    description: "Fetches data on DeFi protocols by category (e.g., 'Liquid Staking', 'Lending', 'Bridge', 'Dexes', 'Restaking', 'Liquid Restaking', 'CDP', 'RWA', 'Yield', 'Derivatives', 'Farm', 'Basis Trading', 'Yield Aggregator', 'Cross Chain', 'Services', 'Launchpad', 'Leveraged Farming', 'Indexes', 'Privacy', 'Staking Pool', 'Payments', 'Liquidity Manager', 'Synthetics', 'Insurance', 'Prediction Market', 'Options', 'Decentralized Stablecoin', 'Algo-Stables', 'NFT Lending', 'NFT Marketplace', 'CeDeFi', 'Options Vault', 'Gaming', 'Uncollateralized Lending', 'Reserve Currency', 'SoFi', 'DEX Aggregator', 'RWA Lending', 'NftFi', 'Ponzi', 'Oracle', 'Wallets', 'Telegram Bot', 'MEV') and optionally filters by blockchain (e.g., 'Ethereum', 'Solana', 'Arbitrum', 'Base', 'Cardano', 'Near', 'BSC', 'Sui'). Returns protocol details including rank, name, TVL, TVL percentage changes, market cap to TVL ratio, and fees/revenue for the past 24 hours, 7 days, and 30 days.",
    author: 'Shinkai',
